...
export default function SavedListings() {
  ...
  const filtered = activeTab === 'all'
    ? listings
    : listings.filter((p) => (p.type || 'apartment').toLowerCase() === activeTab)
    ...
    <div className="flex min-h-screen flex-col bg-white">
      ...
      <div className="sticky top-0 z-10 bg-white px-4 pt-4 pb-0 border-b border-border">
        <div className="mb-3 flex items-center gap-3">
          ...
          <h1 className="text-base font-bold text-text-primary">Saved Listings</h1>
        </div>
        ...
        {loading
          ...
          ? (
            <div className="flex flex-col items-center py-20 text-center">
              <svg width="48" height="48" fill="none" viewBox="0 0 24 24" stroke="#CBD5E1" strokeWidth="1.5" className="mb-3">
                <path d="M20.84 4.61a5.5 5.5 0 00-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 00-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 000-7.78z" />
              </svg>
              <p className="text-sm font-semibold text-text-primary">No saved listings</p>
              <p className="mt-1 text-xs text-text-tertiary">Properties you save will appear here</p>
              <button
      ...
      {showConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-6">
          <div className="w-full max-w-sm rounded-2xl bg-white p-6 text-center">
            <h3 className="mb-2 text-base font-bold text-text-primary">Clear all saved?</h3>
